...
namespace NotepadByRohan
{
    public partial class MainForm : Form
    {
        ...
        public void menuitem_MouseEnter(object sender,EventArgs e)
        {
        ...
        //******************************************************************************************
        public void myTabControlZ_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (myTabControlZ.TabCount > 0)
            {
                ...
                if (tabpage.Text.Contains("Untitled"))
                {
                    ...
                    this.Text = "NotepaByRohan [ "+tabpage.Text+" ]";
            ...
            {
                FilenameToolStripLabel.Text = "NotepaByRohan";
                this.Text = "NotepaByRohan";
                UpdateWindowsList_WindowMenu();
            }
        }
        ...
        public void WindowListEvent_Click(object sender, EventArgs e)
        {
        ...
        //*************************************************************************************
        public void File_MenuItem_DropDownOpening(object sender, EventArgs e)
        {
            if(myTabControlZ.TabCount>0)
            {
        ...
        //*************************************************************************************
        public void Edit_Menu_DropDownOpening(object sender, EventArgs e)
        {
            if(myTabControlZ.TabCount>0)
            {
        ...
        //*************************************************************************************
        public void View_MenuItem_DropDownOpening(object sender, EventArgs e)
        {
            if(myTabControlZ.TabCount>0)
            {
        ...
        //*************************************************************************************
        public void Run_MenuItem_DropDownOpening(object sender, EventArgs e)
        {
            if(myTabControlZ.TabCount>0)
            {
...
//*****************************************************************************************************************************
        ...
        public void File_New_MenuItem_Click(object sender, EventArgs e)
        {
            MyTabPage tabpage = new MyTabPage(this);
            ...
            this.Text = "NotepadByRohan [ Untitled "+count+" ]";
        ...
        //          File -> Open
        //***************************************************************************
        public void File_Open_MenuItem_Click(object sender, EventArgs e)
        {
            StreamReader strReader;
            String str;
            if (openFileDialog1.ShowDialog() == DialogResult.OK)
            {
                ...
                foreach (string filename in files)
                {
                    ...
                    FilenameToolStripLabel.Text = filename;
                    this.Text = "NotepadByRohan [ " + fname+" ]";
                }
        ...
        //         File -> Save
        //***************************************************************************
        public void File_Save_MenuItem_Click(object sender, EventArgs e)
        {
        ...
        //         File -> Save As
        //***************************************************************************
        public void File_SaveAs_MenuItem_Click(object sender, EventArgs e)
        {
            if (myTabControlZ.TabCount > 0)
            {
                TabPage tabpage = myTabControlZ.SelectedTab;
        ...
        //         File -> Save All
        //***************************************************************************
        public void File_SaveAll_MenuItem_Click(object sender, EventArgs e)
        {
            if (myTabControlZ.TabCount > 0)
            {
        ...
        //         File -> Close
        //***************************************************************************
        public void File_Close_MenuItem_Click(object sender, EventArgs e)
        {
            if (myTabControlZ.TabCount > 0)
            {
                TabPage tabpage = myTabControlZ.SelectedTab;
                if (tabpage.Text.Contains("*"))
                {
                    DialogResult dg = MessageBox.Show("Do you want to save " + tabpage.Text + " file before close ?", 
                    ...
                    if (dg == DialogResult.Yes)
                    {
                        ...
                        if (myTabControlZ.TabCount == 0)
                        {
                            FilenameToolStripLabel.Text = "NotepadByRohan";
                            count = 1;
                        }
                    }
                    else
        ...
        //         File -> Close All
        //***************************************************************************
        public void File_CloseAll_MenuItem_Click(object sender, EventArgs e)
        {
            if (myTabControlZ.TabCount > 0)
            {
        ...
        //         File -> Exit
        //***************************************************************************
        public void File_Exit_MenuItem_Click(object sender, EventArgs e)
        {
            this.Close();
        }
...
//*****************************************************************************************************************************
        ...
        //         Edit -> Cut
        //***************************************************************************
        public void Edit_Cut_MenuItem_Click(object sender, EventArgs e)
        {
            if(myTabControlZ.TabCount>0)
            {
                var _myRichTextBox = (MyRichTextBox)myTabControlZ.TabPages[myTabControlZ.SelectedIndex].Controls[0];
        ...
        //         Edit -> Copy
        //***************************************************************************
        public void Edit_Copy_MenuItem_Click(object sender, EventArgs e)
        {
            if (myTabControlZ.TabCount > 0)
            {
                var _myRichTextBox = (MyRichTextBox)myTabControlZ.TabPages[myTabControlZ.SelectedIndex].Controls[0];
        ...
        //         Edit -> Paste
        //***************************************************************************
        public void Edit_Paste_MenuItem_Click(object sender, EventArgs e)
        {
            if (myTabControlZ.TabCount > 0)
            {
                var _myRichTextBox = (MyRichTextBox)myTabControlZ.TabPages[myTabControlZ.SelectedIndex].Controls[0];
        ...
        //         Edit -> Undo
        //***************************************************************************
        public void Edit_Undo_MenuItem_Click(object sender, EventArgs e)
        {
            if (myTabControlZ.TabCount > 0)
            {
                var _myRichTextBox = (MyRichTextBox)myTabControlZ.TabPages[myTabControlZ.SelectedIndex].Controls[0];
        ...
        //         Edit -> Redo
        //***************************************************************************
        public void Edit_Redo_MenuItem_Click(object sender, EventArgs e)
        {
            if (myTabControlZ.TabCount > 0)
            {
                var _myRichTextBox = (MyRichTextBox)myTabControlZ.TabPages[myTabControlZ.SelectedIndex].Controls[0];
        ...
        //         Edit -> Find
        //***************************************************************************
        public void Edit_Find_MenuItem_Click(object sender, EventArgs e)
        {
            if (myTabControlZ.TabCount > 0)
            {
                var _myRichTextBox = (MyRichTextBox)myTabControlZ.TabPages[myTabControlZ.SelectedIndex].Controls[0];
        ...
        //         Edit -> Replace
        //***************************************************************************
        public void Edit_Replace_MenuItem_Click(object sender, EventArgs e)
        {
            if (myTabControlZ.TabCount > 0)
            {
                var _myRichTextBox = (MyRichTextBox)myTabControlZ.TabPages[myTabControlZ.SelectedIndex].Controls[0];
        ...
        //         Edit -> GoTo
        //***************************************************************************
        public void Edit_GoTo_MenuItem_Click(object sender, EventArgs e)
        {
            if (myTabControlZ.TabCount > 0)
            {
                var _myRichTextBox = (MyRichTextBox)myTabControlZ.TabPages[myTabControlZ.SelectedIndex].Controls[0];
        ...
        //         Edit -> Select All
        //***************************************************************************
        public void Edit_SelectAll_MenuItem_Click(object sender, EventArgs e)
        {
            if (myTabControlZ.TabCount > 0)
            {
                var _myRichTextBox = (MyRichTextBox)myTabControlZ.TabPages[myTabControlZ.SelectedIndex].Controls[0];
        ...
        //***************************************************************************
        public void Edit_ChangeCase_Upper_MenuItem_Click(object sender, EventArgs e)
        {
            if (myTabControlZ.TabCount > 0)
            {
        ...
        //***************************************************************************
        public void Edit_ChangeCase_Lower_MenuItem_Click(object sender, EventArgs e)
        {
            if (myTabControlZ.TabCount > 0)
            {
                int select_index = myTabControlZ.SelectedIndex;
        ...
        //***************************************************************************
        public void Edit_ChangeCase_Sentence_MenuItem_Click(object sender, EventArgs e)
        {
            if (myTabControlZ.TabCount > 0)
            {
                int select_index = myTabControlZ.SelectedIndex;
...
//*****************************************************************************************************************************
        ...
        //         View -> Font
        //***************************************************************************
        public void View_Font_MenuItem_Click(object sender, EventArgs e)
        {
            if (myTabControlZ.TabCount > 0)
            {
                int select_index = myTabControlZ.SelectedIndex;
        ...
        //         View -> Fore Color
        //***************************************************************************
        public void View_ForeColor_MenuItem_Click(object sender, EventArgs e)
        {
            if (myTabControlZ.TabCount > 0)
            {
                int select_index = myTabControlZ.SelectedIndex;
        ...
        //         View -> Back Color
        //***************************************************************************
        public void View_BackColor_MenuItem_Click(object sender, EventArgs e)
        {
            if (myTabControlZ.TabCount > 0)
            {
                int select_index = myTabControlZ.SelectedIndex;
        ...
        //***************************************************************************
        public void View_DocumentSelector_MenuItem_Click(object sender, EventArgs e)
        {
        ...
        //         View -> ToolStrip
        //***************************************************************************
        public void View_ToolStrip_MenuItem_Click(object sender, EventArgs e)
        {
        ...
        //         View -> Status Strip
        //***************************************************************************
        public void View_StatusStrip_MenuItem_Click(object sender, EventArgs e)
        {
        ...
        public void View_FullScreen_MenuItem_Click(object sender, EventArgs e)
        {
        ...
        //         View -> Tabs Align -> Top
        //***************************************************************************
        public void View_TabsAlign_Top_MenuItem_Click(object sender, EventArgs e)
        {
        ...
        //***************************************************************************
        public void View_TabsAlign_Bottom_MenuItem_Click(object sender, EventArgs e)
        {
...
//*****************************************************************************************************************************
        ...
        //         Run -> Run
        //***************************************************************************
        public void Run_Run_MenuItem_Click(object sender, EventArgs e)
        {
        ...
        //         Run -> Run In Browser
        //***************************************************************************
        public void Run_RunInBrowser_MenuItem_Click(object sender, EventArgs e)
        {
            if (myTabControlZ.TabCount > 0)
            {
                int select_index = myTabControlZ.SelectedIndex;
        ...
        //***************************************************************************
        public void Run_PreviewHTMLPage_MenuItem_Click(object sender, EventArgs e)
        {
            if (myTabControlZ.TabCount > 0)
            {
                int select_index = myTabControlZ.SelectedIndex;
        ...
        //         Run -> Google Search
        //***************************************************************************
        public void Run_GoogleSearch_MenuItem_Click(object sender, EventArgs e)
        {
        ...
        //         Run -> Facebook
        //***************************************************************************
        public void Run_Facebook_MenuItem_Click(object sender, EventArgs e)
        {
        ...
        //         Run -> Twitter
        //***************************************************************************
        public void Run_Twitter_MenuItem_Click(object sender, EventArgs e)
        {
...
//*****************************************************************************************************************************
        ...
        //         Window -> Restart
        //***************************************************************************
        public void Window_Restart_MenuItem_Click(object sender, EventArgs e)
        {
            Application.Restart();
        }
        ...
        //***************************************************************************
        public void Window_CloseAllWindows_MenuItem_Click(object sender, EventArgs e)
        {
...
//*****************************************************************************************************************************
        ...
        //         Help -> Online Help
        //***************************************************************************
        public void Help_OnlineHelp_MenuItem_Click(object sender, EventArgs e)
        {
            Process.Start("https:\\www.google.com");
        }
        ...
        //         Help -> About
        //***************************************************************************
        public void Help_About_MenuItem_Click(object sender, EventArgs e)
        {
...
//*****************************************************************************************************************************
        public void New_ToolStripButton_Click(object sender, EventArgs e)
        {
            File_New_MenuItem_Click(sender, e);
        }

        public void Open_ToolStripButton_Click(object sender, EventArgs e)
        {
        ...
        public void SaveAs_ToolStripButton_Click(object sender, EventArgs e)
        {
            File_SaveAs_MenuItem_Click(sender, e);
        }
        ...
        public void Cut_ToolStripButton_Click(object sender, EventArgs e)
        {
            Edit_Cut_MenuItem_Click(sender, e);
        }

        public void Copy_ToolStripButton_Click(object sender, EventArgs e)
        {
            Edit_Copy_MenuItem_Click(sender, e);
        }

        public void Paste_ToolStripButton_Click(object sender, EventArgs e)
        {
            Edit_Paste_MenuItem_Click(sender, e);
        }

        public void Undo_ToolStripButton_Click(object sender, EventArgs e)
        {
            Edit_Undo_MenuItem_Click(sender, e);
        }

        public void Redo_ToolStripButton_Click(object sender, EventArgs e)
        {
            Edit_Redo_MenuItem_Click(sender, e);
        }

        public void Find_ToolStripButton_Click(object sender, EventArgs e)
        {
            Edit_Find_MenuItem_Click(sender, e);
        }

        public void GoTo_ToolStripButton_Click(object sender, EventArgs e)
        {
            Edit_GoTo_MenuItem_Click(sender, e);
        }

        public void Font_ToolStripButton_Click(object sender, EventArgs e)
        {
            View_Font_MenuItem_Click(sender, e);
        }

        public void PreviewHTMLPage_ToolStripButton_Click(object sender, EventArgs e)
        {
...
//*****************************************************************************************************************************
        public void Cut_ContextMenuItem_Click(object sender, EventArgs e)
        {
            Edit_Cut_MenuItem_Click(sender, e);
        }

        public void Copy_ContextMenuItem_Click(object sender, EventArgs e)
        {
            Edit_Copy_MenuItem_Click(sender, e);
        }

        public void Paste_ContextMenuItem_Click(object sender, EventArgs e)
        {
            Edit_Paste_MenuItem_Click(sender, e);
        }

        public void SelectAll_ContextMenuItem_Click(object sender, EventArgs e)
        {
            Edit_SelectAll_MenuItem_Click(sender, e);
        }

        public void Upper_ContextMenuItem_Click(object sender, EventArgs e)
        {
            Edit_ChangeCase_Upper_MenuItem_Click(sender, e);
        }

        public void Lower_ContextMenuItem_Click(object sender, EventArgs e)
        {
            Edit_ChangeCase_Lower_MenuItem_Click(sender, e);
        }

        public void Sentence_ContextMenuItem_Click(object sender, EventArgs e)
        {
            Edit_ChangeCase_Sentence_MenuItem_Click(sender, e);
        }

        public void SetFont_ContextMenuItem_Click(object sender, EventArgs e)
        {
            View_Font_MenuItem_Click(sender, e);
        }

        public void PreviewHTMLPage_ContextMenuItem_Click(object sender, EventArgs e)
        {
            Run_PreviewHTMLPage_MenuItem_Click(sender, e);
        }
...
//*****************************************************************************************************************************
        public void myTabControl_ContextMenuStrip_Opening(object sender, CancelEventArgs e)
        {
            if(myTabControlZ.TabCount>0)
            {
                TabPage tabpage = myTabControlZ.SelectedTab;
        ...
        public void myTabControl_Save_MenuItem_Click(object sender, EventArgs e)
        {
            File_Save_MenuItem_Click(sender, e);
        }

        public void myTabControl_SaveAll_MenuItem_Click(object sender, EventArgs e)
        {
            File_SaveAll_MenuItem_Click(sender, e);
        }

        public void myTabControl_Close_MenuItem_Click(object sender, EventArgs e)
        {
            File_Close_MenuItem_Click(sender, e);
        }

        public void myTabControl_CloseAll_MenuItem_Click(object sender, EventArgs e)
        {
            File_CloseAll_MenuItem_Click(sender, e);
        }


        public void myTabControl_CloseAllButThis_MenuItem_Click(object sender, EventArgs e)
        {
        ...
        public void myTabControl_OpenFileFolder_MenuItem_Click(object sender, EventArgs e)
        {
            if(myTabControlZ.TabCount>0)
            {
